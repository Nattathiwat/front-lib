      ...
      <Form @submit="onSubmitRepass()" @invalid-submit="onInvalidSubmit">
        <div class="repass-detail">
          <div class="group-input">
            ...
            <cpn-input  v-model="data.new_password"
                        name="new_password"
                        rules="required"
                        type="password"
                        icon="eye"
          ...
          <div class="group-input">
            <div class="name">ยืนยันรหัสผ่านใหม่ <span class="required">*</span></div>
            <cpn-input  v-model="data.confirm_password"
...
export default {
  ...
  props: {
    resetPassword: { type: Boolean, default() {return false}},
  }
}
</script>
